...
export const Experience = () => {
  const {
    ...
    godPosY: { value: 2, min: -10, max: 10, step: 0.1, label: "Position Y" },
    godPosZ: { value: 0, min: -10, max: 10, step: 0.1, label: "Position Z" },
    ...
    godRotZ: { value: 0, min: -Math.PI, max: Math.PI, step: 0.01, label: "Rotation Z" },
